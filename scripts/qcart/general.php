...
* http://opensolution.org/Quick.Cart/docs/?id=en-requirements#5
*/
...
*/
$config['allowed_ip_admin_panel'] = '[[clientip]]';
...
$config['last_login'] = "1410344443";
$config['before_last_login'] = "1408517811";

$config['manual_link'] = 'http://opensolution.org/Quick.Cart/docs/?id='.( ( $config['admin_lang']=='pl' ) ? 'pl' : 'en' ).'-';
