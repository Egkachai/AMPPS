 ...
 */
$db_config = array(
	'user'     => '[[softdbuser]]',     // your MySQL username
	'password' => '[[softdbpass]]',     // ...and password
	'name'     => '[[softdb]]',  // the name of the database
	'host'     => '[[softdbhost]]',    // MySQL Server (typically 'localhost')
);
