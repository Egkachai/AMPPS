...
@define ('SALT', '[[salt]]'); # put a strong string here
...
@define ('STORAGE_SERVER', '[[softdbhost]]');
@define ('STORAGE_DB', '[[softdb]]');
@define ('STORAGE_USER', '[[softdbuser]]');
@define ('STORAGE_PASSWORD', '[[softdbpass]]');
